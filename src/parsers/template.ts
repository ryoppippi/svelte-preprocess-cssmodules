 ...
 */
function updateMultipleClasses(processor: Processor, classNames: string): string {
 ...
 */
function parseExpression(processor: Processor, expression: TemplateNode): void {
 ...
 */
function addDynamicVariablesToElements(processor: Processor, node: TemplateNode, cssVar: CssVariables): void {
 ...
 */
function cssVariables(processor: Processor): CssVariables {
