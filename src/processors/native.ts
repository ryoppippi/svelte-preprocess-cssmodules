 ...
 */
function updateSelectorBoundaries(boundaries: Boundaries[], start: number, end: number): Boundaries[] {
 ...
 */
function parser(processor: Processor): void {
...
async function nativeProcessor(ast: AstLegacy, content: string, filename: string, options: PluginOptions): Promise<string> {
