...
describe('mixed Mode', () => {
	...
	it('cSS Modules class targetting children', async () => {
		const source
      = '<style module>\n'
	...
	it('cSS Modules class has a parent', async () => {
		const source
      = '<style module>\n'
	...
	it('cSS Modules chaining pseudo selector', async () => {
		const source
      = '<style module>\n'
	...
	it('cSS Modules class is used within a media query', async () => {
		const source
      = '<style module>\n'
