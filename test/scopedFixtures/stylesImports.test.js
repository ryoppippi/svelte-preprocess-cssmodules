...
describe('scoped Mode Imports', () => {
	...
	it('import all classes from stylesheet', async () => {
		const source
    = `<script>
	...
	it('destructuring imports', async () => {
		const source
    = `<script>
	...
	it('multiple selectors imported', async () => {
		const source
    = `<script>
	...
	it('class directives with default specifier', async () => {
		const source
    = `<script>
      import style from './assets/class.module.css';
    </script>
