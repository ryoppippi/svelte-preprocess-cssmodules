...
describe('bind variable to CSS', () => {
	...
	it('deep nested element in components', async () => {
		const output = await compiler({
			source: `${script}
	...
	it('root elements bound with js expression', async () => {
		const output = await compiler({
	...
	it('root elements has if statement', async () => {
		const output = await compiler({
			source: `${script}`
	...
	it('root elements has `each` statement', async () => {
		const output = await compiler({
			source: `${script}`
	...
	it('root element has `each` statement', async () => {
		const output = await compiler({
			source: `${script}`
			+ `{#await promise}`
			+ `<p>...waiting</p>`
	...
	it('root element has `key` statement', async () => {
		const output = await compiler({
			source: `${script}`
			+ `{#key value}`
